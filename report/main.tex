...
\input{sections/03-jordan-algebras}
\input{sections/04-spectral-idempotent}
\input{sections/05-epsilon-jb}
\input{sections/06-bridge-theorem}
\input{sections/06b-faithful-invariant}
\input{sections/07-exact-factorization}
\input{sections/08-classical-stability}
\input{sections/09-structure-programme}
\input{sections/10-exponent}
