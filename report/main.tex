...
%     ground-truth source file and the byte-verbatim quote it is matched to.
%   - PROVENANCE.md is the audit ledger (source path, SHA256, exact quote).
...
\input{sections/07-structure-programme}
