# w26_cluster_audit — HOLDS WITH IMPROVEMENT: A = 1, DIMENSION-FREE (codex hostile audit, 2026-06-11)
# Brief: /tmp/codex-sigma-wall/w26_cluster_audit/brief.md. Long form: experiments/out/w26_cluster_audit/audit_report.md.

Done. Long-form audit is in [audit_report.md](/tmp/codex-sigma-wall/w26_cluster_audit/audit_report.md:1). Progress log is in [progress.md](/tmp/codex-sigma-wall/w26_cluster_audit/progress.md:1). No `answer.md` was created.

Verdict: **HOLDS WITH IMPROVEMENT**. The claimed greedy chart is valid, but the rank-dependent constant is an artifact. A maximum-volume actual-row basis gives corrected constants:

\[
A=1,\quad \Lambda\le 1,\quad E\le R\eta
\]

The remaining gap is not coefficient rank-dependence; it is the L3 support-concentration estimate on mass outside the eta-pivot clusters.
