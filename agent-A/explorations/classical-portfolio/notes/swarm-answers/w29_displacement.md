# w29_displacement — DIED-AT (max-volume version); general-row version REFUTED at delta=0 (codex, 2026-06-11)
# Brief: /tmp/codex-sigma-wall/w29_displacement/brief.md. Long form: experiments/out/w29_displacement/proof.md.

VERDICT: DIED-AT for the max-volume representative lemma. I also found a clean counterexample to the general-row version at `delta=0`, so the lemma cannot be stated for arbitrary rows.

Long-form artifact: [proof.md](/tmp/codex-sigma-wall/w29_displacement/proof.md)  
Numerics/code: [displacement_audit.py](/tmp/codex-sigma-wall/w29_displacement/displacement_audit.py), [displacement_numeric_summary.txt](/tmp/codex-sigma-wall/w29_displacement/displacement_numeric_summary.txt), [displacement_numeric_results.json](/tmp/codex-sigma-wall/w29_displacement/displacement_numeric_results.json)  
Progress log: [progress.md](/tmp/codex-sigma-wall/w29_displacement/progress.md)
